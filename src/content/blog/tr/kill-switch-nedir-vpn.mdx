...
Sağlayıcı seçerken kill switch'in hangi platformlarda hangi seviyede çalıştığını mutlaka kontrol edin, kurulumdan sonra kendi bağlantınızda sızıntı kontrolü yapın ve mümkünse always-on modunu açık tutun. Kaynak alanları için [en iyi gizlilik VPN'leri karşılaştırmamıza](/en-iyi/gizlilik) göz atın — kill switch kapsamını platform bazında inceleyebilirsiniz.
