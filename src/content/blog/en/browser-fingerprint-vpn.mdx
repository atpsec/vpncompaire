...
Many brands promise "total anonymity"; VPN + standard Chrome still allows fingerprinting. Our [sources and limitations](/methodology) page explains source context; it does not publish a laboratory score.
