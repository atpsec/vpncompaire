...
**Tip**: Airport Wi-Fi is usually slow. Choose nearest server or use WireGuard protocol.
...
**Tip**: Some hotels block VPN traffic. Use VPN with obfuscation feature.
...
**Special Cases:**
- **China**: VPNs blocked, special obfuscated servers needed
