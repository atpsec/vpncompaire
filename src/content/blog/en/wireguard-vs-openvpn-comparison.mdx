...
Numeric results vary substantially with the device, implementation, route, ISP and server load; this site does not publish a fixed laboratory table. WireGuard's minimal design targets lower overhead, but use the self-check in our [VPN speed and performance article](/en/blog/vpn-speed-optimization) for your own connection.
