...
Enable "WebRTC leak protection" in the app. Providers like Mullvad, Proton VPN and NordVPN offer this. See [privacy VPN picks](/best-vpn/privacy) for consistent protection.
...
WebRTC leak is easy to overlook. Test, configure browser and VPN together. The [sources and limitations](/methodology) page explains why a reader-run leak test is not a provider-wide verdict.
