...
Depends on jurisdiction. In Turkey VPN use is legal; bypassing exchange terms-of-service is a separate issue and can result in account closure. Detail in our [VPN legality guide](/en/blog/is-vpn-legal).
