...
If you're looking for documented split-tunneling support, check our [VPN comparison page](/comparison), where the same provider fields are organized side by side. Confirm current platform support with the provider before subscribing.
