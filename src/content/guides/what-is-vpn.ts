...
const tr: WhatIsVpnContent = {
  ...
  choosing: {
    ...
    closingBefore: "Bu üç kriteri en iyi karşılayan seçimler için ",
    closingLink: "2026'nın en iyi VPN'leri",
    closingAfter: " sıralamamıza göz at.",
  },
...
const en: WhatIsVpnContent = {
  ...
  choosing: {
    ...
    closingBefore: "For the picks that best meet these three criteria, check out our ",
    closingLink: "best VPNs of 2026",
    closingAfter: " ranking.",
  },
...
const de: WhatIsVpnContent = {
  ...
  choosing: {
    ...
    closingBefore: "Für die Optionen, die diese drei Kriterien am besten erfüllen, wirf einen Blick auf unser ",
    closingLink: "Ranking der besten VPNs 2026",
    closingAfter: ".",
  },
