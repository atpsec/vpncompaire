...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = copy[locale];
  return { title: t.title, description: t.description, alternates: localizedAlternates("/metodoloji", locale), openGraph: { title: t.title, description: t.description, url: absoluteUrl("/metodoloji", locale), type: "article" } };
}
