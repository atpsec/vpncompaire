...
const copy = {
  tr: {
    ...
    freshness: ["Fiyat, plan, özellik ve denetim bilgileri değişebilir; tarih yalnızca bulunduğu yerde geçerli bir kontrol noktasıdır.", "Sabit bir yenileme aralığı veya her sayfanın düzenli olarak yeniden kontrol edildiği sözü vermiyoruz.", "Bir bilgi doğrulanamıyorsa kesin gerçek gibi sunulmamalı; okuyucu güncel resmî kaynağı kontrol etmelidir.", "Hata veya güncellik sorunu bildirmek için ilgili URL'yi ve kaynağı iletişim sayfasından gönderebilirsiniz."],
  ...
  en: {
    ...
    freshness: ["Pricing, plans, features and audit information can change; a displayed date is only a timestamp for the information it accompanies.", "We do not promise a fixed refresh interval or regular rechecking of every page.", "Information that cannot be confirmed should not be treated as certain; readers should verify current official sources.", "To report an error or outdated claim, send the URL and supporting source through the contact page."],
  ...
  de: {
    ...
    freshness: ["Preise, Tarife, Funktionen und Auditinformationen können sich ändern; ein Datum gilt nur für die Information, neben der es steht.", "Wir versprechen kein festes Aktualisierungsintervall und keine regelmäßige Prüfung jeder Seite.", "Nicht bestätigte Informationen sollten nicht als sichere Tatsachen gelten; aktuelle offizielle Quellen sind selbst zu prüfen.", "Fehler oder veraltete Angaben können mit URL und Beleg über die Kontaktseite gemeldet werden."],
