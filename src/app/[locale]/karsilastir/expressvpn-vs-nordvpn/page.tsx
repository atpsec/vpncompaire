...
import {
  getExpressvpnVsNordvpnContent,
  type AbWinner,
  type ExpressvpnVsNordvpnContent,
} from "@/content/comparisons/expressvpn-vs-nordvpn";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const c = getExpressvpnVsNordvpnContent(appLocale);
  return {
    title: c.metaTitle,
...
export default async function Page({ params }: Props) {
  ...
  const c = getExpressvpnVsNordvpnContent(locale);
  const a = getProduct("expressvpn", locale)!;
  const b = getProduct("nordvpn", locale)!;
...
function WinnerBadge({
  ...
  winner: AbWinner;
  content: ExpressvpnVsNordvpnContent;
}) {
  if (winner === "tie") {
