...
const CONTENT = {
  tr: {
    ...
    guides: [
      ...
      { slug: "ogrenciler-icin-vpn", title: "Öğrenciler için VPN bilgi rehberi", desc: "Kampüs Wi-Fi, akademik erişim ve öğrenci bütçesi için kaynakları karşılaştırma.", tag: "Öğrenciler" },
  ...
  en: {
    ...
    guides: [
      ...
      { slug: "ogrenciler-icin-vpn", title: "VPN information guide for students", desc: "How to compare sources for campus Wi-Fi, academic access and student budgets.", tag: "Students" },
