...
import { getQuestionEvidence, getResearchQuestion, RESEARCH_QUESTIONS } from "@/data/research";
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      ...
      <JsonLd data={{ "@context": "https://schema.org", "@type": "WebPage", "@id": `${absoluteUrl(`/research/questions/${slug}`)}#page`, name: question.title, description: question.question, url: absoluteUrl(`/research/questions/${slug}`), dateModified: "2026-09-19", isPartOf: { "@type": "WebSite", name: "VPN Advisor", url: absoluteUrl("/") } }} />
      <Container size="lg" className="py-12 sm:py-16 lg:py-20">
        ...
        <p className="mt-10 text-sm text-ink-muted">Last updated: 2026-09-19 · Unknown values are not negative answers.</p>
      </Container>
    </>
  );
}
