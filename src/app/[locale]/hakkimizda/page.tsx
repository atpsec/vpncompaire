...
const copy = {
  tr: {
    ...
    authorBody: "VPN Advisor kişisel bir yayın projesidir; gerçekte var olmayan editör personeli veya uzman unvanı kullanmayız. İçerikler VPN Advisor adıyla yayınlanır; dış kaynaklar, güncelleme tarihleri ve düzeltme süreci güvenilirliğin temelidir.",
  ...
  en: {
    ...
    authorH2: "Authorship and responsibility", authorBody: "VPN Advisor is a personal publishing project; we do not imply staff editors or expert credentials that do not exist. Content is published under the VPN Advisor name, with sources, update dates and a correction process made visible.",
  ...
  de: {
    ...
    authorH2: "Autorschaft und Verantwortung", authorBody: "VPN Advisor ist ein persönliches Publikationsprojekt; wir suggerieren keine nicht existierenden Redakteure oder Expertenqualifikationen. Inhalte erscheinen unter dem Namen VPN Advisor; Quellen, Aktualisierungsdaten und ein Korrekturprozess bleiben sichtbar.",
