...
const COPY: Record<Variant, Record<SupportedLocale, Copy>> = {
  "use-case": {
    ...
    tr: {
      ...
      methodology: "Kaynakları ve sınırları incele",
  ...
  guide: {
    en: {
      ...
      methodology: "See sources and limits",
    ...
    tr: {
      ...
      methodology: "Kaynakları ve sınırları gör",
    ...
    de: {
      ...
      methodology: "Quellen und Grenzen ansehen",
