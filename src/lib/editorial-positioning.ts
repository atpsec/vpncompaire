...
export const editorialPositioning = {
  tr: {
    ...
    methodologyTag: "Kaynaklar ve açık sınırlamalar",
    primaryCta: "VPN Karşılaştırmalarını Gör",
    secondaryCta: "Kaynakları ve sınırları gör",
  ...
  en: {
    ...
    methodologyTag: "Sources and clear limitations",
    primaryCta: "View VPN Comparisons",
    secondaryCta: "Sources and limitations",
  ...
  de: {
    ...
    methodologyTag: "Quellen und klare Grenzen",
    primaryCta: "VPN-Vergleiche ansehen",
    secondaryCta: "Quellen und Grenzen",
