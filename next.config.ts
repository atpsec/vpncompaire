...
const cspDirectives = [
  ...
  "img-src 'self' data: blob: https://flagcdn.com https://source.unsplash.com https://images.unsplash.com",
  "font-src 'self' data:",
  "connect-src 'self' https://plausible.io https://1.1.1.1 https://cloudflare-dns.com https://speed.cloudflare.com https://*.cloudflare.com",
